...
//Class and Code from: https://github.com/awslabs/aws-sdk-android-samples/tree/master/AndroidPubSub
//Tweaked to suit IoT Application Development Project
public class TestConnection extends AppCompatActivity {

    static final String LOG_TAG = TestConnection.class.getCanonicalName();
